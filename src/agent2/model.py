...
class ResNetAgent(nn.Module):
    ...
    goal: Predict reversals in ranging markets (Multi-class).
    """
    def __init__(self, input_dim: int, hidden_dim: int = 128, num_blocks: int = 4, num_classes: int = 3):
        super().__init__()
